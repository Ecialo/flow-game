...
Допустим у нас есть юнит, который бьёт топором. Бьёт вот так (см картинку ниже). 
![unit with grid](https://github.com/Ecialo/flow-game/blob/concept/grid.png)

Эта область высчитывается относительно того куда смотрит юнит. У топора есть подготовка в 5 тиков, исполнение в 3 тика и откат в 5 тиков. В описаной выше системе возникают вот такие сценарии:
